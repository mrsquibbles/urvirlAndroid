...
/**
 * Created by Squbbles MKV on 3/8/2016.
 */
public class GroupMembersFragment extends ListFragment
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        //set the title
        getActivity().setTitle("Group Members");
    ...
    {
        MembersTask membersTask = new MembersTask(getActivity());
    ...
    private class MembersTask extends UrlJsonAsyncTask
    {
        int HttpResult = 0;

        public MembersTask(Context context)
        {
            super(context);
        }
